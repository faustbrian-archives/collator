...
describe("Collator", () => {
	...
	describe("#isGreaterThan", () => {
		it("should return true", () => {
			...
			expect(subject.isGreaterThan("2.0.0-alpha-10", "2.0.0-alpha-6")).toBeTrue();
		...
		it("should return false", () => {
			...
			expect(subject.isGreaterThan("1.2.3-next.6", "1.2.3-next.10")).toBeFalse();
			expect(subject.isGreaterThan("2.0.0-alpha-6", "2.0.0-alpha-10")).toBeFalse();
			expect(subject.isGreaterThan("2.0.0-alpha.8", "2.0.0-beta.1")).toBeFalse();
		});
	});
	...
	describe("#isGreaterThanOrEqual", () => {
		it("should return true", () => {
			...
			expect(subject.isGreaterThanOrEqual("1.2.3-next.10", "1.2.3-next.6")).toBeTrue();
			expect(subject.isGreaterThanOrEqual("2.0.0-alpha-10", "2.0.0-alpha-6")).toBeTrue();
			expect(subject.isGreaterThanOrEqual("2.0.0-beta.1", "2.0.0-alpha.8")).toBeTrue();
		});
		...
		it("should return false", () => {
			...
			expect(subject.isGreaterThanOrEqual("1.2.3-next.6", "1.2.3-next.10")).toBeFalse();
			expect(subject.isGreaterThanOrEqual("2.0.0-alpha-6", "2.0.0-alpha-10")).toBeFalse();
			expect(subject.isGreaterThanOrEqual("2.0.0-alpha.8", "2.0.0-beta.1")).toBeFalse();
		});
	});
	...
	describe("#isLessThanOrEqual", () => {
		it("should return true", () => {
			...
			expect(subject.isLessThanOrEqual("1.2.3-next.6", "1.2.3-next.10")).toBeTrue();
			expect(subject.isLessThanOrEqual("2.0.0-alpha-6", "2.0.0-alpha-10")).toBeTrue();
			expect(subject.isLessThanOrEqual("2.0.0-alpha.8", "2.0.0-beta.1")).toBeTrue();
		});
		...
		it("should return false", () => {
			...
			expect(subject.isLessThanOrEqual("1.2.3-next.10", "1.2.3-next.6")).toBeFalse();
			expect(subject.isLessThanOrEqual("2.0.0-alpha-10", "2.0.0-alpha-6")).toBeFalse();
			expect(subject.isLessThanOrEqual("2.0.0-beta.1", "2.0.0-alpha.8")).toBeFalse();
		});
	});
});
